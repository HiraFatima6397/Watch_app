      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              StringConstants.powerfulfeatures,
            ...
            Container(
              ...
              child: Center(child: Text(StringConstants.Addtocart,style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),)),
            )
          ],
        ),
      ),
